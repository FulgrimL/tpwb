        ...
        switch (v.modelType) {
            ...
            case "home":
                ...
                $.each(v.modelColumn, function(k, v) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(data) {
                                                    ...
                                                    if (mui.os.android) {
                                                        ...
                                                        sendJsData(JSON.stringify(andJson));
                                                    } else {
                                                        mui.alert("sucess");
                                                    }
                                                    $(".shareS").unbind("click");
                                                    ...
                                                    $(".shareS").click(function() {
                                                        ...
                                                        if (mui.os.android) {
                                                            window.androidx.shareXb(shareTitle, contentText1, url, sharePictureUrl, telNu)

                                                        } else if (mui.os.ios) {
                                                            shareXb(JSON.stringify(andJson))
                                        ...
                                        success: function(data) {
                                            ...
                                            $(".shareS").click(function() {
                                                ...
                                                if (mui.os.android) {
                                                    ...
                                                    shareXb(shareTitle, contentText1, url, sharePictureUrl)
                    ...
                    //                     var shareText = data.data.shareText;
                    //                     var shareTitle = data.data.shareTitle;
                    //                     var sharePictureUrl = data.data.sharePictureUrl;
                    //                     var url = "Wxshow.html?prdId=" + prdId + "&userId=" + userID;
                    //                     // 产品分享
                    ...
                    //                                 if (mui.os.android) {
                    //                                     window.androidx.shareXb(shareTitle, contentText1, url, imageurl, telNu)
                    //                                 } else if (mui.os.ios) {
                    //                                     shareXb(shareTitle, contentText1, url, imageurl, telNu)
