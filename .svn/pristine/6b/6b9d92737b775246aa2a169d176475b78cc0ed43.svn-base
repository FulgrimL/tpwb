        ...
        if (judgeType("#GRPNAME")) {
            ...
            switch (idType) {
                case 1:
                    ...
                    break;
                case 2:
                    $("#GRPIDTYPE").html("护照").attr("value", "P");
                    break;
                case 3:
                    $("#GRPIDTYPE").html("军人证").attr("value", "S");
                    break;
            }
                ...
                $.each(v.modelColumn, function(k, v) {
                    ...
                    if (v.type == "label") {
                        titleHtml = '<div class="mui-input-row row-title expand">' +
                            '<div class="row-title-text">' + v.groupName + '</div>' + '<div class="shareS" style="margin-right:35px"  prdId="' + prdId + '"><img src="../images/call20.png"></div>';
                        if (kk == 0) {
                            if (isFavorited) {
